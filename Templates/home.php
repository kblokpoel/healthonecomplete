...
<body style="background-color: darkslateblue">
    <div class="container" style="background:cornflowerblue">
        ...
        <hr>
        <h4 class="text-warning">Openingstijden</h4>
        <ul class="list-group">
